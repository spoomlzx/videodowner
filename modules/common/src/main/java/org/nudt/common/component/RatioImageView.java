...
public class RatioImageView extends AppCompatImageView {
    ...
    private void init(AttributeSet attrs) {
        ...
        mHeightRatio = a.getFloat(R.styleable.RatioImageView_riv_height_to_width_ratio, mHeightRatio);
        mWidthRatio = a.getFloat(R.styleable.RatioImageView_riv_width_to_height_ratio, mWidthRatio);
