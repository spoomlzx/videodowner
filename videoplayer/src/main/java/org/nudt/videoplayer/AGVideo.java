...
import org.nudt.videoplayer.utils.NetworkUtils;
import org.nudt.videoplayer.view.LoadingView;
import org.nudt.videoplayer.view.PlayAndPauseView;
...
//                        mDownY = y;
    ...
    private void updateConfigChanged(int state) {
        ...
        if (state == Jzvd.SCREEN_FULLSCREEN) {
            ...
            ll_top.setBackgroundResource(cn.jzvd.R.drawable.jz_title_bg);
            ll_bottom.setBackgroundResource(cn.jzvd.R.drawable.jz_bottom_bg);
        } else {
